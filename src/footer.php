    ...
    <div class="container p-6 mx-auto">
        <div class="lg:flex">
            <div class="w-full -mx-6 lg:w-2/5">
                <div class="px-6">
                    <a href="#" class="flex">
                        <img class="w-auto h-20" src="assets/logo1.png" alt="">
                        <img class="w-auto h-20" src="assets/logo2.png" alt="">
                    </a>

                    <p class="max-w-sm mt-2 text-gray-500 dark:text-gray-400">An integrated digital document request</p>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        otpForm.addEventListener('submit', async (e) => {
            ...
            const getEmail = document.getElementById('email-see').value;
            showLoader();
            console.log(getEmail, otpCode)
            try {
                const res = await fetch('../data/verify.php', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
    ...
    const hideModal = document.getElementById('cancel-submit');
