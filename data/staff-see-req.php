            ...
            <div class="max-w-2xl px-4 py-2 mx-auto ">
                ...
                <form action="#">
                    ...
                    <div class="flex items-center space-x-4">
                        <?php if (htmlspecialchars($req['REQ_STATUS']) != 'pending') {
                        } else { ?>
                            <a href="../staff/verify"
                                target="_blank"
                                id="accept-req"
                        ...
                        <?php if (htmlspecialchars($req['REQ_STATUS']) != 'pending') { ?>
                            <button data-cntrl="<?= htmlspecialchars($req['CTRL_NUM']) ?>" id="" type="button" class="archive-request text-red-600 inline-flex items-center hover:text-white border border-red-600 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900">
                                Archive
                            </button>
                        <?php  } else { ?>
                            <button data-cntrl="<?= htmlspecialchars($req['CTRL_NUM']) ?>" id="" type="button" class="decline-request text-red-600 inline-flex items-center hover:text-white border border-red-600 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900">
                                Decline
                            </button>
                        <?php } ?>
                    </div>
